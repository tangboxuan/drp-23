...
function Recipes() {
    ...
    function getRecipeInformation(ingredients: Ingredient[]) {
        ...
        recipesApi.get("/recipes/findByIngredients", {
            params: {
    ...
    const fridgeOnly = recipeInfo.recipeSummaries
        ...
        .map(function (recipe, i) {
            return <RecipeCard recipeSummary={recipe} recipeDetails={recipeInfo.recipeDetails[i]} key={recipe.id} />
        });
    ...
    return (
        <>
            <div className={getStyle(styles, "container")}>
                ...
                <p className={getStyle(styles, "subtitle")}>Ingredients in use: {names.join(", ")}</p>
