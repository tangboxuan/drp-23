...
function FooterSection({ section, active }: Props) {
  ...
  const recipesIcon = (
    <svg
      className={
        active
          ? getStyle(styles, "recipesActive")
          : getStyle(styles, "recipesInactive")
      }
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
...
const styles = {
  ...
  fridgeActive: ["w-6", "h-7", "fill-selectedRed"],
  fridgeInactive: ["w-6", "h-7", "fill-outlineGray"],
  textActive: ["font-medium", "text-selectedRed", "text-[13px]"],
  textInactive: ["font-medium", "text-outlineGray", "text-[13px]"],
